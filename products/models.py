...
class category(models.Model):
    ...
    title_category = models.ForeignKey('category',on_delete=models.CASCADE,verbose_name="دسته بنده",null=True,blank=True)
...
class Product(models.Model):
    ...
    category_product = models.ManyToManyField(category,related_name="category_sets",verbose_name="دسته بندی",db_index=True,null=True)
